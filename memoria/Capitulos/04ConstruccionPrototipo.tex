...
Este proceso de corte dobla ligeramente los bordes y produce rebabas, que pueden causar que la frecuencia de resonancia no sea calculable mediante el modelo del que se dispone, puesto que el modelo proporciona la frecuencia de resonancia para una lamina lisa. Por lo que antes de montar cualquier lamina en el generador hay que limar los bordes.
...
Dependiendo de las dimensiones de la bobina como pueden ser el radio del núcleo, el diámetro del hilo, el factor de llenado, el numero de espiras, etc, se consiguen unos resultados u otros para un tamaño dado de la bobina por eso para fabricarla es necesario conocer previamente sus dimensiones óptimas para el uso que se va a hacer de ella y como su construcción afecta a la producción de energía.
