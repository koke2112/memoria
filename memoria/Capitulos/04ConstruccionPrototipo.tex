...
\begin{figure}[!h]
        \centering
        \subfloat[Lámina de acero de una paleta de obra.]{\label{fig:cap4:paleta1}\includegraphics[width=0.5\textwidth]{Imagenes/imagenes/cap4/paleta}} 
        \qquad
		\subfloat[Distintos cortes de la paleta.]{\label{fig:cap4:cortes}\includegraphics[width=0.5\textwidth]{Imagenes/imagenes/cap4/cortes}}
\caption{Paleta de obra.}
        \label{fig:cap4:paleta}
\end{figure}

Este acero se va a mecanizar en diferentes tamaños que son 1, 1.5, 2 y 2.5cm como se puede ver en la imagen \ref{fig:cap4:cortes}.
Por otro lado el grosor de este acero es de 0.5mm.

Con todos estos datos ya se esta en disposición de poder calcular la frecuencia de resonancia de cualquier lamina construida con este material.
...
Para esto en principio se dispone de metacrilato y PVC en el \ac{LSI} aunque posteriormente se recurrirá a \ac{PLA} impreso en 3D en las impresoras 3D cedidas por BQ a la \ac{ETSIT}.
...
Para fabricar la bobina es necesario conocer sus dumensiones optimas y como su construccion afecta a la produccion de energia.
