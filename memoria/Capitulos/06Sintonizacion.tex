...
\textbf{Primer método \underline{Modificación del centro de gravedad de la masa del extremo}}
...
//dibujo de masa extra desplazable.(en dropbox)

\textbf{Segundo método \underline{Variación del coeficiente de elasticidad de la lámina}}
...
//dibujo de eletroimanes acutando (en dropbox)
...
//dibujo de laminas paralelas (en dropbox)


\textbf{Tercer método \underline{Variación de los parámetros fisicos de la lámina}}
...
//imagen de sintonizacion_mecanica (grafica) (en dropbox)

Ahora queda estudiar la manera óptima de conseguir variar este parámetro.

\underline{Objetivo:}

\textbf{Variar de forma eficiente la longitud de la lámina.}

\underline{Soluciones:}

La  primera solución es inmediata, requeriría soltar la lámina de la base, desplazarla y volver a ajustarla, con el consiguiente gasto de energía y pérdida de eficiencia. \textbf{Este método no es práctico} para un sistema que tiene que sintonizarse de forma autónoma, y por eso será descartado.
 
 
La segunda solución que se pensó, pasaría por un sistema de engranajes o ruedas dentadas que mediante un motor desplazasen la lamina. Esta solución elimina el problema de soltarla y volver a ajustarla en una nueva posición, sin embargo \textbf{aumenta considerablemente la dificultad de fijarla a la base} y del mecanismo en general por lo que también se descartó.

//meter un dibujo de los engranajes (en dropbox)
...
Volviendo a la tabla [//la tabla de maneras de sintonizar] se aprecia que los métodos de sintonización mecánica, en concreto cambiar las dimensiones, como es el método que aquí se utiliza, no es aplicable mientras el generador esta funcionando, sin embargo mediante la técnica aquí presentada del sintonizador, ese problema desaparece y el generador puede ser sintonizado aun cuando este activo. Esta es la mejora principal conseguida con este proyecto.
