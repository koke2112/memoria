...
%cambiando etiquetas al español
...
\include{Capitulos/02EstadoArte}
%\include{Capitulos/03ReviewStudy}
\include{Capitulos/03DisenoGenerador}
%\include{Capitulos/04DesignStudy}
\include{Capitulos/04ConstruccionPrototipo}
%\include{Capitulos/05ImplementationStudy}
\include{Capitulos/05EntornoDeTrabajo}
\include{Capitulos/06Sintonizacion}
\include{Capitulos/07ResultOpti}
\include{Capitulos/08Futuro}
\include{Capitulos/09Herramientas}
...
\include{Apendices/vibgen}


\include{Apendices/comergen}
