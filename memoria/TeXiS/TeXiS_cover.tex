...
% Imagen de la contraportada (escudo)
\def\imagenContraportadaVal{Imagenes/Vectorial/Todo}
\newcommand{\imagenContraportada}[1]{
\def\imagenContraportadaVal{#1}
}
\def\escalaImagenContraportadaVal{1.0}
\newcommand{\escalaImagenContraportada}[1]{
\def\escalaImagenContraportadaVal{#1}
}
...
% Tutor
\def\directorPortadaVal{\tutor}
\newcommand{\directorPortada}[1]{
\def\directorPortadaVal{#1}
}

% Fecha de publicacion
\def\fechaPublicacionVal{\fecha}
...
%\setlength{\margenPortada}{3.4cm}
\setlength{\margenPortada}{3cm}
...
% Affiliation
\begin{center}
{\setlength{\parindent}{0cm} \huge \textbf{\textsc{\universidad\\[10mm]}}}
{\setlength{\parindent}{0cm} \LARGE \textbf{\textsc{\centroEducacion\\[12mm]}}}
\end{center}
...
\begin{center}
  {\LARGE \textbf{\tipoDocumentoVal}}\\[5mm]
  {\Large \textbf{\titulacion}}
\end{center}
...
\begin{center}
\vskip 1.2cm
\huge{\textbf{\textsc{\tituloPortadaVal}}}
\vskip 0.5cm
\end{center}
...
\large
{\centering\LARGE\textbf{\textsc{\tipodocumento}}\\[1cm]}
\begin{tabular}[t]{p{3.5cm} p{10cm}}
\bf Titulo: &  \sc \titulo \\ \\
\bf Autor:  & \sc \autor \\ \\
\bf Tutor: & \sc \tutor \\ \\
%\bf Academic \\
%\bf Advisor: & \sc \ponente \\ \\
\bf Departamento: & \sc \departamento \\
\end{tabular}
\bigskip
\vspace{0.7cm}

\begin{center}
%\LARGE\textbf{\textsc{Thesis Committee}}
\LARGE\textbf{\textsc{Tribunal Académico}}
\end{center}

\vspace{0.7cm}
\large
\begin{tabular}[t]{p{3.5cm} l}
\bf Presidente: & \sc D. \presidente   \\ \\
\bf Vocal: & \sc  D.  \vocal \\ \\
\bf Secretario: & \sc D. \secretario  \\ \\
\bf Suplente: & \sc D. \suplente \\ \\
\end{tabular}
...
\vspace{2cm}
%\begin{flushright}
\hspace{4.5cm}Madrid, a \hspace{0.7cm} de \hspace{3.5cm} de 
%\end{flushright}
...
% Logo
\begin{center}
  \includegraphics[width=0.75\textwidth]{\imagenContraportadaVal}
\end{center}
...
% Logo del grupo y del departamento
%\begin{figure}[h!]
%\centering
%\includegraphics[width=0.33\textwidth]{\logoGrupo}
%\qquad
%\centering
%\includegraphics[width=0.35\textwidth]{\logoDepartamento}
%\end{figure}

%\vspace{0.9cm}

%\begin{center}
%  \includegraphics[scale=\escalaImagenContraportadaVal]{\imagenContraportadaVal}
%\end{center}
